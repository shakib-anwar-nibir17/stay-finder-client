...
const Footer = () => {
  ...
  return (
    <footer className="bg-custom-color-2 text-white lg:px-[100px] px-10">
        ...
        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          ...
          <div className="col-span-2">
            <div>
              ...
              <p className="mt-4">
                Discover your perfect stay with Stay Finder – the ultimate hotel
                booking app designed to make your travel experience seamless and
                memorable.
              </p>
            </div>
          </div>
